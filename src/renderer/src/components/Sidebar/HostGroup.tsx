    ...
    <div>
      ...
      >
        ...
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"
             style={{ color: '#4D6EA9', transition: 'transform .15s', transform: group.expanded ? 'rotate(90deg)' : 'rotate(0deg)' }}>
        ...
        {/* Name */}
        <span className="flex-1 text-xs font-medium truncate" style={{ color: '#F7F9FA' }}>
          {group.name}
        </span>

        {/* Count */}
        <span className="text-xs px-1.5 py-0.5 rounded" style={{ background: 'rgba(255,255,255,0.06)', color: '#5A5E73' }}>
          {groupHosts.length}
        </span>
